...
const SERVER_DIR = '/Users/oscarmarina/Projects/my-docs-server';
  ...
  try {
    ...
    db.prepare(
      ...
      ON CONFLICT(query_hash) DO UPDATE SET
        ...
        access_count = access_count + 1
    `
    ).run(text.substring(0, 500), queryHash, model, Buffer.from(embedding.buffer));
...
// 3. CREATE THE SERVER
const server = new Server({name: 'mcp-knowledge-mind', version: '1.0.0'}, {capabilities: {tools: {}}});
